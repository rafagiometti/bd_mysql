...
-- Cáculo preço médio agrupado por categoria

SELECT c.descricao,AVG(preco) AS media_preco FROM tb_produtos JOIN tb_categorias as c ON tb_produtos.categoria_id = c.id GROUP BY categoria_id;
